...
namespace Sisus.Init
{
	...
	public static class InstantiateExtensions
	{
		...
		/// <para>
		/// The argument should either be received by the created <see cref="Object"/> during its initialization (such during the Awake event)
		...
		/// <para>
		/// Arguments should either be received by the created <see cref="Object"/> during its initialization (such during the Awake event)
